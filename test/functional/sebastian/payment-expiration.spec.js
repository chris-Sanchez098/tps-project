...
describe('Payment-expiration-CV', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('Payment-expiration-CV', async function() {
...
describe('Payment-expiration-CI-1', function() {
  this.timeout(30000)
  let driver
  let vars
  beforeEach(async function() {
  ...
  it('Payment-expiration-CI-1', async function() {
    await driver.get("http://localhost:1111/")
    await driver.manage().window().setRect({ width: 733, height: 728 })
    await driver.findElement(By.linkText("Add to cart")).click()
    await driver.findElement(By.css(".col-6:nth-child(2) .btn")).click()
    ...
    await driver.findElement(By.id("Field-numberInput")).sendKeys("4242 4242 4242 4242")
    await driver.findElement(By.id("Field-expiryInput")).click()
    await driver.findElement(By.id("Field-expiryInput")).sendKeys("abcd")
    await driver.findElement(By.id("Field-cvcInput")).click()
    await driver.findElement(By.id("Field-cvcInput")).sendKeys("567")
    await driver.findElement(By.id("Field-countryInput")).click()
    await driver.switchTo().defaultContent()
    await driver.findElement(By.id("button-text")).click()
    assert(await driver.findElement(By.id("payment-message")).getText() == "Your card\\\'s expiration date is incomplete.")
  })
})

describe('Payment-expiration-CI-2', function() {
  this.timeout(30000)
  let driver
  let vars
  beforeEach(async function() {
  ...
  it('Payment-expiration-CI-2', async function() {
    await driver.get("http://localhost:1111/")
    await driver.manage().window().setRect({ width: 733, height: 728 })
    await driver.findElement(By.linkText("Add to cart")).click()
    await driver.findElement(By.css(".col-6:nth-child(2) .btn")).click()
    ...
    await driver.findElement(By.id("Field-numberInput")).sendKeys("4242 4242 4242 4242")
    await driver.findElement(By.id("Field-expiryInput")).click()
    await driver.findElement(By.id("Field-expiryInput")).sendKeys("\'\'")
    await driver.findElement(By.id("Field-cvcInput")).click()
    await driver.findElement(By.id("Field-cvcInput")).sendKeys("567")
    await driver.findElement(By.id("Field-countryInput")).click()
    await driver.switchTo().defaultContent()
